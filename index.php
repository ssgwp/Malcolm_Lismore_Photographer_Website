    ...
    <header class="header" id="home">
      <nav>
        ...
        <ul class="nav__links" id="nav-links">
          ...
          <li><a href="#" onclick="alert('Please Login First !', 'error'); return false;">CONTACT US</a>
        </li>        
        </ul>
      </nav>
      <nav>
      ...
      <div class="section__container footer__container">
        ...
        <div class="footer__col">
          <ul class="footer__links">
            <li><a href="">HOME</a></li>
            <li><a href="#" onclick="alert('Please Login First !', 'error'); return false;">GALLERY</a></li>
            <li><a href="#about">ABOUT US</a></li>
            <li><a href="#" onclick="alert('Please Login First !', 'error'); return false;">BLOG</a></li>
            <li><a href="#" onclick="alert('Please Login First !', 'error'); return false;">PACKAGES</a></li>
            <li><a href="#" onclick="alert('Please Login First !', 'error'); return false;">CONTACT US</a></li>
          </ul>
        </div>
        <div class="footer__col">
